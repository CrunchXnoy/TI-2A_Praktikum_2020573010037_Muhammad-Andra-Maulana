...
<head>
    ...
    <title>SIPBATIK | Account Settings</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-9">
                ...
                <h6>Last update is at : 16/04/2021</h6>
                <hr>
                <form action="proses/settings/cpassword.php" method="POST">
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="npassword2" class="form-label">Repeat Password</label>
                            <input type="text" class="form-control" id="npassword2">
                        </div>
                        <div class="col">
                        </div>
                    </div>
