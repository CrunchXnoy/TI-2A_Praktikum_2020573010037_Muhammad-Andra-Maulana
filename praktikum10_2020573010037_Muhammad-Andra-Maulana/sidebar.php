  ...
  <div style="width: 280px;">
    ...
    <li class="nav-item">
        <a href="index.php" class="nav-link active" aria-current="page">
          <svg class="bi bi-person-circle me-2" width="16" height="16">
            <use xlink:href="#home" />
          </svg>
          Home
        </a>
      ...
      <li>
        <a href="peminjaman.php" class="nav-link link-dark">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-handbag me-2" viewBox="0 0 16 16">
      ...
      <?php }if ($row['level']=='admin'){ ?>
      <li>
        <a href="database.php" class="nav-link link-dark">
