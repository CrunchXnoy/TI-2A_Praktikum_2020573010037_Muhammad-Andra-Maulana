          ...
          <tbody>
            ...
            <?php foreach ($datapeminjaman as $dp) : ?>
              <tr>
                ...
                <td><?= $dp["status"]; ?></td>
                <td>
                  <span class="badge rounded-pill bg-primary" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalview<?= $dp["kode_barang"]; ?>">
                    View
                  </span>
                  <span class="badge rounded-pill bg-warning" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modaledit<?= $dp["kode_barang"]; ?>">
                    Edit
                  </span>
                  <span class="badge rounded-pill bg-danger" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modaldelete<?= $dp["kode_barang"]; ?>">
                    Delete
                  </span>
                </td>
              </tr>
