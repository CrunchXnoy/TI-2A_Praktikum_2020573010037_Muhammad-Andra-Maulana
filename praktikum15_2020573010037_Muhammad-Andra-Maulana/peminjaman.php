...
LEFT JOIN user usr ON pem.user = usr.id WHERE email='$_SESSION[email]'");
//end
            ...
            <?php foreach ($databarang as $db) : ?>
              <tr>
                ...
                <td>
                  ...
                  elseif ($db["status"] == 4) echo "<span class='badge rounded-pill bg-info'>Dikembalikan</span>";
                  ?>
                </td>
                <td>
                  <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modaledit<?= $db["kode_barang"]; ?>" <?php if ($db["status"] == "2" || $db["status"] =="4") {
                                                                                                                                                echo "disabled";
                                                                                                                                              }; ?>>
